...
function validateUserName(){
    ...
    if(username.match(/^[a-zA-z][a-zA-Z0-9_]{3,20}$/)){
        ...
        $("#validateUserNameMessage").attr("class","text-danger").text("UserName Format Wrong!").show();
    }
}
...
function validatePassWord(){
    ...
    if(!password.match(/[a-zA-z0-9][a-zA-Z0-9_]{3,20}/)){
        $("#validatePassWordMessage").attr("class","text-danger").text("UserName Format Wrong!").show();
    }
}
